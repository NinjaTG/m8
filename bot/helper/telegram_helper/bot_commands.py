...
class _BotCommands:
    def __init__(self):
        ...
        self.UnzipMirrorCommand = (f'extract_mirror{CMD_INDEX}', f'uzm{CMD_INDEX}')
        self.ZipMirrorCommand = (f'zipmirror{CMD_INDEX}', f'zm{CMD_INDEX}')
        self.QbMirrorCommand = (f'qb_mirror{CMD_INDEX}', f'qm{CMD_INDEX}')
        ...
        self.YtdlCommand = (f'yt_mirror{CMD_INDEX}', f'y{CMD_INDEX}')
        self.YtdlZipCommand = (f'yt_zip_mirror{CMD_INDEX}', f'yz{CMD_INDEX}')
        ...
        self.QbLeechCommand = (f'qb_leech{CMD_INDEX}', f'ql{CMD_INDEX}')
        ...
        self.YtdlLeechCommand = (f'yt_leech{CMD_INDEX}', f'yl{CMD_INDEX}')
